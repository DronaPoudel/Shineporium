...
import SingleProductCSS from './ProductSingle.module.css';
import data from '../../data/Data.json'
const ProductSingle = () => {
    const pid = useParams();

      console.log( data.products.plasticGloves,pid.id,"glovessssssssssssssss")
    return (
        <>
     <p className = {SingleProductCSS.text_start}>
     {data.products.plasticGloves.filter(sid=>sid.id == (pid.id)).map(items=>{
         return(
            //  <p>{items.name}</p>
            <div>
